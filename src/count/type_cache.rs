...
//     nats: HashMap<Id, usize>,
// }

// impl TypeSizeCache {
//     /// Pre-compute sizes for every nat, data, and fun type node in the e-graph.
//     pub(crate) fn build<L: LabelLanguage>(graph: &EGraph<L>) -> Self {
...
//     fn ensure_nat<L: LabelLanguage>(&mut self, graph: &EGraph<L>, id: NatId) {
...
//     fn ensure_data<L: LabelLanguage>(&mut self, graph: &EGraph<L>, id: DataId) {
...
//     fn ensure_fun<L: LabelLanguage>(&mut self, graph: &EGraph<L>, id: FunId) {
