...
mod tests {
    ...
    fn run_egpraph_with_start(prog: &str, exp_best: &str, exp_best_cost: f64) {
        ...
        let converted: String = super::stringconversion::convert_string(prog)
        ...
        assert_approx_eq!(best_cost, exp_best_cost, 0.000_001);
    }
    ...
    fn direct_recexpr() {
        ...
        assert_approx_eq!(cost, 1.026, 0.000_001);
    }
    ...
    fn direct_recexpr_2() {
        ...
        let (cost, _) = super::rules::run(&expr, 180, false, false);
        assert_approx_eq!(cost, 1.133, 0.000_001);
    }
